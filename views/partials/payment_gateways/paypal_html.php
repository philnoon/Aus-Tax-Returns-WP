<?php
	...
	<form action="<?php echo $paypal_url; ?>/cgi-bin/webscr" method="post" target="_top">
		...
		<input type="hidden" name="return" value="<?php echo admin_url(); ?>admin.php?page=lcp_leads&ref=<?php echo $leaddet->hash; ?>" />
		<input type="hidden" name="notify_url" value="<?php echo admin_url(); ?>admin.php?page=lcp_leads&ref=<?php echo $leaddet->hash; ?>" />
